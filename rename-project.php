...
searchDirectoryFiles(getcwd() . '/', 'package-batch-reassignment', $argv[1]);

searchDirectoryFiles(getcwd() . '/', 'PackageBatchReassignment', dashesToCamelCase($argv[1], true));

searchDirectoryFiles(getcwd() . '/', 'Package Batch Reassignment', dashesToCamelCase($argv[1], true, ' '));
