<?php
namespace ProcessMaker\Package\PackageBatchReassignment;

use Illuminate\Support\Facades\Route;
use Illuminate\Support\ServiceProvider;
use ProcessMaker\Package\Packages\Events\PackageEvent;
use ProcessMaker\Package\PackageBatchReassignment\Http\Middleware\AddToMenus;
use ProcessMaker\Package\PackageBatchReassignment\Listeners\PackageListener;

class PackageServiceProvider extends ServiceProvider
{

    // Assign the default namespace for our controllers
    protected $namespace = '\ProcessMaker\Package\PackageBatchReassignment\Http\Controllers';
    ...
    public function boot()
    {
        ...
        $this->loadViewsFrom(__DIR__ . '/../resources/views/', 'package-batch-reassignment');

        $this->publishes([
            __DIR__.'/../public' => public_path('vendor/processmaker/packages/package-batch-reassignment'),
        ], 'package-batch-reassignment');
